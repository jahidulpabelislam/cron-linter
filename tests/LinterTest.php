...
final class LinterTest extends TestCase {
    ...
    public static function invalidProvider(): array {
        return [
            ...
            ["15-30-45 * * * * php test.php", ["Line 1 has too many values in the range for Minute: 15-30-45"]],
            ["*/60 * * * * php test.php", ["Line 1 has invalid value for Minute: 60"]],
            ...
            ["* 6-12-18 * * * php test.php", ["Line 1 has too many values in the range for Hour: 6-12-18"]],
            ...
            ["* * 7-14-21 * * php test.php", ["Line 1 has too many values in the range for Day of month: 7-14-21"]],
            ["* * */32 * * php test.php", ["Line 1 has invalid value for Day of month: 32"]],
            ...
            ["* * * 3-6-9 * php test.php", ["Line 1 has too many values in the range for Month: 3-6-9"]],
            ...
            ["* * * * 2-4-6 php test.php", ["Line 1 has too many values in the range for Day of week: 2-4-6"]],
            ["* * * * */7 php test.php", ["Line 1 has invalid value for Day of week: 7"]],
