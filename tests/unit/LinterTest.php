...
final class LinterTest extends TestCase {
    ...
    public static function invalidProvider(): array {
        return [
            ...
            ["1/2/3 * * * * php test.php", ["Line 1 contains an invalid value for Minute: 1 (must be wildcard `*` or a range)", "Line 1 contains too many step values for Minute: 1/2/3"]],
            ...
            ["* 1/2/3 * * * php test.php", ["Line 1 contains an invalid value for Hour: 1 (must be wildcard `*` or a range)", "Line 1 contains too many step values for Hour: 1/2/3"]],
            ...
            ["* * 7/14/28 * * php test.php", ["Line 1 contains an invalid value for Day of month: 7 (must be wildcard `*` or a range)", "Line 1 contains too many step values for Day of month: 7/14/28"]],
            ...
            ["* * * 8/12/16 * php test.php", ["Line 1 contains an invalid value for Month: 8 (must be wildcard `*` or a range)", "Line 1 contains too many step values for Month: 8/12/16"]],
            ...
            ["* * * * 3/6/9 php test.php", ["Line 1 contains an invalid value for Day of week: 3 (must be wildcard `*` or a range)", "Line 1 contains too many step values for Day of week: 3/6/9"]],
